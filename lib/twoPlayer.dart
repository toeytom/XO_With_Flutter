...
class TwoPlayyer extends StatefulWidget {
  final Widget child;

  TwoPlayyer({Key key, this.child}) : super(key: key);

  _TwoPlayyerState createState() => _TwoPlayyerState();
}

class _TwoPlayyerState extends State<TwoPlayyer> {
  List<String> xo = [
    "",
    "",
    "",
